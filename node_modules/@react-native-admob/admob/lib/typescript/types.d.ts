...
export declare type MaxAdContentRating = 'G' | 'MA' | 'PG' | 'T';
...
export declare type AdType = 'Interstitial' | 'Rewarded' | 'RewardedInterstitial' | 'AppOpen';
export declare type FullScreenAdEvent = 'adPresented' | 'adFailedToPresent' | 'adDismissed' | 'adLoaded' | 'adFailedToLoad';
export declare type RewardedAdEvent = FullScreenAdEvent | 'rewarded';
export declare type FullScreenAdHandlerType = (() => void) | ((error: AdError) => void);
export declare type RewardedAdHandlerType = FullScreenAdHandlerType | ((reward: Reward) => void);

...
public final class UpdateDao_Impl extends UpdateDao {
  ...
  public UpdateDao_Impl(RoomDatabase __db) {
    ...
    this.__insertionAdapterOfUpdateEntity = new EntityInsertionAdapter<UpdateEntity>(__db) {
      ...
      public void bind(SupportSQLiteStatement stmt, UpdateEntity value) {
        if (value.getLaunchAssetId() == null) {
          ...
          stmt.bindLong(1, value.getLaunchAssetId());
        }
        final String _tmp;
        _tmp = __converters.jsonObjectToString(value.getManifest());
        if (_tmp == null) {
          stmt.bindNull(2);
        } else {
        ...
        final int _tmp_1;
        _tmp_1 = __converters.statusToInt(value.getStatus());
        stmt.bindLong(3, _tmp_1);
        final int _tmp_2;
        _tmp_2 = value.getKeep() ? 1 : 0;
        stmt.bindLong(4, _tmp_2);
        final Long _tmp_3;
        _tmp_3 = __converters.dateToLong(value.getLastAccessed());
        if (_tmp_3 == null) {
          stmt.bindNull(5);
        } else {
          stmt.bindLong(5, _tmp_3);
        }
        stmt.bindLong(6, value.getSuccessfulLaunchCount());
        stmt.bindLong(7, value.getFailedLaunchCount());
        final byte[] _tmp_4;
        _tmp_4 = __converters.uuidToBytes(value.getId());
        if (_tmp_4 == null) {
          stmt.bindNull(8);
        } else {
        ...
        final Long _tmp_5;
        _tmp_5 = __converters.dateToLong(value.getCommitTime());
        if (_tmp_5 == null) {
          stmt.bindNull(9);
        } else {
        ...
        if (value.getRuntimeVersion() == null) {
          ...
          stmt.bindString(10, value.getRuntimeVersion());
        }
        if (value.getScopeKey() == null) {
          stmt.bindNull(11);
        } else {
          stmt.bindString(11, value.getScopeKey());
        }
      }
    };
    this.__deletionAdapterOfUpdateEntity = new EntityDeletionOrUpdateAdapter<UpdateEntity>(__db) {
      ...
      public void bind(SupportSQLiteStatement stmt, UpdateEntity value) {
        final byte[] _tmp;
        _tmp = __converters.uuidToBytes(value.getId());
        if (_tmp == null) {
          stmt.bindNull(1);
        } else {
    ...
    this.__updateAdapterOfUpdateEntity = new EntityDeletionOrUpdateAdapter<UpdateEntity>(__db) {
      ...
      public void bind(SupportSQLiteStatement stmt, UpdateEntity value) {
        ...
        final byte[] _tmp_6;
        _tmp_6 = __converters.uuidToBytes(value.getId());
        if (_tmp_6 == null) {
          stmt.bindNull(12);
        } else {
  ...
  public void _keepUpdate(final UUID id) {
    ...
    int _argIndex = 1;
    final byte[] _tmp;
    _tmp = __converters.uuidToBytes(id);
    if (_tmp == null) {
  ...
  public void _markUpdateWithStatus(final UpdateStatus status, final UUID id) {
    ...
    int _argIndex = 1;
    final int _tmp;
    _tmp = __converters.statusToInt(status);
    _stmt.bindLong(_argIndex, _tmp);
    _argIndex = 2;
    final byte[] _tmp_1;
    _tmp_1 = __converters.uuidToBytes(id);
    if (_tmp_1 == null) {
      _stmt.bindNull(_argIndex);
    } else {
  ...
  public List<UpdateEntity> _loadLaunchableUpdatesForProjectWithStatuses(final String scopeKey,
    ...
    for (UpdateStatus _item : statuses) {
      final int _tmp;
      _tmp = __converters.statusToInt(_item);
